...
export default function Header() {
    ...
    return (
        <div className="py-2 border-b border-dashed flex gap-3 sticky top-0 z-50 left-0 right-0 bg-background/45 backdrop-blur-md">
            ...
            {/* <motion.div className="h-10 bg-gradient-to-r from-sky-300 to-blue-300 rounded-md border border-black flex-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200"></motion.div> */}
